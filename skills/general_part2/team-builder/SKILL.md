...
If no agents are found after running `egc agents` and probing file locations, inform the user: "No agents found. Run `egc agents` to verify your setup." Then stop.
