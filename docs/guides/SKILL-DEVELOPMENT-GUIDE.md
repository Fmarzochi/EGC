...
Describe scenarios where gemini should use this skill.
...
| `origin` | No | Source identifier (e.g., `egc`, `community`, project name) |
...
Write content that gemini can **immediately use**:
...
2. **Test with gemini Code**:
   ...
   gemini should reference your skill's patterns.
   ```

3. **Verify activation**:
   - Ask gemini to explain a concept from your skill
