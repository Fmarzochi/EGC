...
echo "  6. The tag push ALSO triggers its own CI run on the tag ref."
echo "     The release is NOT done until that run is terminal and green:"
echo "       gh run list --branch v${VERSION}"
echo "  7. Sweep the project inbox for Run-failed alerts, then verify the"
echo "     published artifact end to end before announcing anywhere:"
echo "       npm pack @egchq/egc@${VERSION} and install it into a scratch HOME"
