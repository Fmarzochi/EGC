...
**`egc dashboard`** - अपना ब्राउज़र `http://localhost:7890` पर खोलें और देखें कि आपका AI एजेंट क्या कर रहा है, लाइव। टूल कॉल, फाइल एडिट, shell कमांड, टोकन उपयोग, मेमोरी स्थिति और एजेंट स्थिति रीयल-टाइम में। `egc init` के बाद डैशबोर्ड स्वचालित रूप से शुरू होता है।

```
egc dashboard          # मिशन कंट्रोल शुरू करें (egc init के बाद स्वचालित रूप से शुरू होता है)
egc dashboard stop     # पृष्ठभूमि सर्वर बंद करें
egc dashboard status   # जांचें कि सर्वर चल रहा है या नहीं
```
...
_अभी तक कोई टूल पार्टनर नहीं — [पहले बनें](https://github.com/sponsors/Fmarzochi)_

#### वार्षिक प्रायोजक

जो समर्थक 12+ महीनों से EGC का समर्थन कर रहे हैं, उन्हें अवतार, नाम और लिंक के साथ एक समर्पित अनुभाग मिलता है।

_पहले वार्षिक प्रायोजक बनें — [GitHub Sponsors](https://github.com/sponsors/Fmarzochi) · [PayPal](https://www.paypal.com/donate/?business=fmarzochi%40gmail.com&currency_code=USD)_
