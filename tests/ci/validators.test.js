...
function runTests() {
  ...
  if (test('accepts all valid model values (haiku, sonnet, gemini-2.5-pro)', () => {
    ...
    fs.writeFileSync(path.join(testDir, 'sonnet.md'),
      '---\nmodel: sonnet\ntools: Read, Write\n---\n# Sonnet Agent');
    fs.writeFileSync(path.join(testDir, 'gemini-2.5-pro.md'),
