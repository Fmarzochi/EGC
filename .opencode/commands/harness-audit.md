...
The script audits the current working directory by default and auto-detects whether the target is the EGC repo itself or a consumer project using EGC.
...
5. Suggested EGC skills to apply next
